...
?>
  ...
  ?>
                        ...
                        <form id="formAccountSettings" method="post" enctype="multipart/form-data">
                          <div class="row">
                            <div class="mb-3 col-md-6">
                              ...
                              <input class="form-control" type="text" id="cusName" name="cusName" value="<?php echo $row['FullName']; ?>" autofocus />
                            </div>
                            <div class="mb-3 col-md-6">
    ...
    if (isset($_POST['editBtn'])) {
      ...
      $query = mysqli_query($conn, "UPDATE user SET FullName = '$cusName', Email = '$email', NumPhone = '$phoneNumber', Password = '$password'  WHERE UserID = '$uid'");
