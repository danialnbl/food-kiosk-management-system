...
?>
  ...
  <body>
    ...
    <script>
      ...
      $(".opn").click(function() {
        ...
        $("#kioskIDEdit").val(col[5].innerText).change();
  ...
  if (isset($_POST['editBtn'])) {
    ...
    $query = mysqli_query($conn, "UPDATE menu SET ItemName = '$menuName', ItemDesc = '$menuDesc', ItemPrice = '$menuPrice', Availability = '$menuAvailability', Stock = '$menuStock', KioskID = $KioskID WHERE MenuID = '$uid'");
